...
<html>
	...
	<!--	<link href="assets\css\enqdisp_modal.css" rel="stylesheet" type="text/css">
		<link href="assets\css\enqedit_modal.css" rel="stylesheet" type="text/css">-->
    ...
    <body class="fixed-left">
        ...
        <!-- Sidebar -->
            ...
            <div class="content-page">
                ...
                <div class="content">
					...
					<?php
						$cd=$_SESSION['Centre_Id'];
						include("connection.php");
						$str="select * from enquiry where Centre_Code in(select Centre_Code from centre where Centre_Id=$cd ) order by Person_Id desc";
						$res=mysqli_query($conn,$str);
					?>
                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped  table-colored table-info draggable">
                                        ...
                                        <tr id="tr2">                                            
										   ...
										   <td draggable="true" ondragstart="drag(event)" id="<?php echo $row[8]; ?>"><?php echo $row[8]; ?></td>
										   <td draggable="true" ondragstart="drag(event)" id="<?php echo $row[10]; ?>"><?php echo $row[10]; ?></td>
										   
										   <td draggable="true" ondragstart="drag(event)"  id="<?php echo $row[0]; ?>"> <button type="button" class="btnview  btn-success"  id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal1"> <i class="fa  fa-eye"> </i> </button> </td>
										   <td draggable="true" ondragstart="drag(event)"width='5%'><button type="button" class="btnupd  btn-warning"  id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal"> <i class="ion-plus-circled  "> </i> </button> </td>
		...
		<div class="modal" id="MyModal" aria-labelledby="myModalLabel" data-animation="bounceIn">
			...
			<section class="panel panel-info panel-color">
			   <header class="panel-heading">
					<h2 class="panel-title"> Add Patinet </h2>
		...
		<center><div class="modal fade" id="MyModal1" aria-labelledby="myModalLabel" data-animation="bounceIn">
				<section class="col-md-4"></section>
			<div class="modal-block col-md-4">
                <section class="panel panel-info panel-color  ">
                    <header class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text" id="id1" name="res1">
		...
		<script src="assets\js\enqdisp.js"></script>
