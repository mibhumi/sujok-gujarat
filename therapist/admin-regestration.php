                                ...
                                <div class="card-box chi-back">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-9 ">
                                            ...
                                            <h4 class="header-title m-t-0">Therapist Regestration</h4>
                                            ...
                                            <div class="p-20">
                                                <form >
                                                    <div class="form-group">
                                                        <label for="userName">Therapist Name<span class="text-danger">*</span></label>
                                                        <input type="text"  parsley-trigger="change" required placeholder="Enter therapist name" class="form-control" id="userName">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="emailAddress">Username<span class="text-danger">*</span></label>
                                                        <div>
                                                            <input type="email" class="form-control" required  placeholder="Enter username/e-mail">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pass1">Password<span class="text-danger">*</span></label>
                                                        <input id="pass1" type="password" placeholder="Password" required class="form-control" required >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="passWord2">Confirm Password <span class="text-danger">*</span></label>
                                                        <input data-parsley-equalto="#pass1" type="password" required placeholder="Password" class="form-control" id="passWord2" required >
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="contact" parsley-trigger="change" placeholder="Enter contact number" class="form-control" id="contact" required >
                                                    </div>
													
                                                    <div class="form-group">
											
                                                        <label>profile photo<span class="text-danger">*</span></label>
                                                        <input type="file" name="remark" required  class="form-control" id="pic" required >
                                                    </div>
													<div class="form-group">
