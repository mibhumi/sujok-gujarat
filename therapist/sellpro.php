        ...
        <!-- Sidebar -->
                ...
                <div class="content">
					...
					$strproname="select * from product where Product_Id in(select Product_Id from inventory where Centre_Id='$row[5]') ";
												...
												while($recordpro=mysqli_fetch_array($otptproname))
											{
												...
												<input type="number" name="tot" id="tot" class="form-control">
												</div>
												<div class="form-group" >
												...
												<div class="form-group" >
												<input type="submit" name="submit" id="submit" value="submit" class="btn1 btn btn-success ">
												<span id="div_payu" hidden><span class="pm-button"><!--<a href="https://www.payumoney.com/paybypayumoney/#/321025">--><a href="https://www.payumoney.com/paybypayumoney/#/BF526979E344ACE52C01B76B99676B12"><img src="payumoney-logo1.png" height="99" width="100" /></a></span></span>
			...
			$sqlstk="select  * from inventory where Product_Id='".$proid."' and Centre_Id=$centreid";
									...
									<div class="form-group col-md-3">
                                                    ...
                                                    <h3><span id="nes" class="text-danger"></span></h3>
													</div>
