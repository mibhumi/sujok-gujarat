...
<legend><center><h2><b>Package Form</b></h2></center></legend><br>						
  ...
  <input name="Package_Name" id="Package_Name" placeholder="Package Name" class="form-control" type="text" data-bv-field="Package_Name"><i class="form-control-feedback" data-bv-icon-for="Package_Name" style="display: none;"></i>
    </div>
</div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Description" id="Description" placeholder="Package Description" class="form-control" type="text" data-bv-field="Description"><i class="form-control-feedback" data-bv-icon-for="Description" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  <label class="col-md-4 control-label">Package Charging</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  
  <input name="Package_Charge" id="Package_Charge" placeholder="Package Charge" class="form-control" type="text" data-bv-field="Package_Charge"><i class="form-control-feedback" data-bv-icon-for="Package_Charge" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  <label class="col-md-4 control-label">Total Seating</label> 
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
  
  <input name="Seating" id="Seating" placeholder="Total seating" class="form-control" type="text" data-bv-field="Seating"><i class="form-control-feedback" data-bv-icon-for="Seating" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Remark" id="Remark" placeholder="Remark" class="form-control" type="text" data-bv-field="Remark"><i class="form-control-feedback" data-bv-icon-for="confirm_password" style="display: none;"></i>
    </div>
  </div>
</div>
...
$('#action').click(function(){
				debugger;
		    if($('#Package_Name').val()==null)
			{
				$.ajax({
					url:"action.php",
					method:"GET",
					data:{Package_Name:$('#Package_Name').val(),Description:$('#Description').val(),Charge:$('#Package_Charge').val(),Seating:$('#Seating').val(),Remark:$('#Remark').val()},
