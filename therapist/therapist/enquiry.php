                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
									<li><a href="new-product.php">Add Product</a></li>						c
                                ...
                                <div class="card-box chi-back">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-9 ">
                                            ...
                                            <h4 class="header-title m-t-0">Enquiry</h4>
                                            ...
                                            <div class="p-20">
												...
												<b><span>Date : </span><span id="demo"></span>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  required placeholder="Enter person name" class="form-control" id="patientname">
                                                    </div>
													...
													<button type="submit" name="submit" class="btn btn-success waves-effect m-l-5">
														...
														<button type="button" name="enquiry" class="btn btn-primary waves-effect m-l-5">
                                                            Enquiry
                                                        </button>
