...
<html>
    <head>
        ...
        <!-- App title -->
        <title>Sujok Therapist Profile</title>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
									...
									<li><a href="therapist_password.php"><i class="ti-user m-r-5"></i> Change Password</a></li>
                ...
                <!-- Start content -->
                   	<!--kaam ka-->
                                            ...
                                            <div class="text-center bhumi">
                                                   <img id="profile" src="img_thep/<?php echo $row[2]; ?>" style="height:250px;width:275px;" class="img-circle img-thumbnail" alt="profile pic">
													</form>		
											</div>
							</div>
								<div class="col-md-1 ">
