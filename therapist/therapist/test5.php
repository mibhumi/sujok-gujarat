                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
							...
							<li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class=" mdi mdi-cart-plus"></i><span> PACKAGES </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
									<li><a href="add-package.php">Add Package</a></li>
									<li><a href="patientdisp.php">Edit Package</a></li>
									<li><a href="patientdisp.php">Delete package</a></li>
								</ul>
                            </li>
...
<div class="container">
    <form class="well form-horizontal bv-form" method="post" enctype="multipart/form-data" id="contact_form" novalidate="novalidate">
<fieldset>

<!-- Form Name -->
<legend><center><h2><b>Package Form</b></h2></center></legend><br>						
						<div class="form-group has-feedback">
  <label class="col-md-4 control-label">Package Name</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  
  <input name="Product_Name" id="Product_Name" placeholder="Enter Product Name" class="form-control" type="text" data-bv-field="Product_Name"><i class="form-control-feedback" data-bv-icon-for="Product_Name" style="display: none;"></i>
    </div>
</div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Product_Price" id="Product_Price" placeholder="Enter Price" class="form-control" type="text" data-bv-field="Product_Price"><i class="form-control-feedback" data-bv-icon-for="Product_Price" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Description" id="Description" placeholder="Enter Product Description" class="form-control" type="text" data-bv-field="Description"><i class="form-control-feedback" data-bv-icon-for="Description" style="display: none;"></i>
    </div>
  </div>
</div>
...
<!--<div class="form-group has-feedback">
  ...
  <input name="Product_Image" id="Product_Image" placeholder="Product Image" class="form-control" type="file" data-bv-field="Product_Image" style="border-bottom:0"><i class="form-control-feedback" data-bv-icon-for="Product_Image" style="display: none;"></i>
    </div>
  </div>
</div>-->

<input type="file" id="img_file">
<img id="img_disp" class="img-responsive" style="max-height:100 px; max-width:100px" />
...
<div class="form-group has-feedback">
  ...
  <input name="Remark" id="Remark" placeholder="Remark" class="form-control" type="text" data-bv-field="Remark"><i class="form-control-feedback" data-bv-icon-for="Remark" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4"><br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="button" name="action" id="action" class="btn btn-warning">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SUBMIT <span class="glyphicon glyphicon-send"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
  </div>
</div>
...
$('#action').click(function(){
		    	...
		    	$.ajax({
					...
					method:"POST",
					data:{Product_Name:$('#Product_Name').val(),Product_Price:$('#Product_Price').val(),Description:$('#Description').val(),Product_Image:$('#Product_Image').val(),Remark:$('#Remark').val()},
...
<script>
	...
	$(document).ready(function() {
		...
		function checkFile(){
			...
			if(ext=="")
			{
				$scope.hasimage=0; return false; toastr.error('ypu must select some image','please select some image');
			}
			
			if(ext == "gif" || ext == "jpg" || ext == "png" || ext == "")
				return true;
