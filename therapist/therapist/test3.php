...
<legend><center><h2><b>Package Form</b></h2></center></legend><br>						
  ...
  <input name="Package_Name" placeholder="Package Name" class="form-control" type="text" data-bv-field="Package_Name"><i class="form-control-feedback" data-bv-icon-for="Package_Name" style="display: none;"></i>
    </div>
</div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Description" placeholder="Package Description" class="form-control" type="text" data-bv-field="Description"><i class="form-control-feedback" data-bv-icon-for="Description" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Package_Charge" placeholder="Package Charge" class="form-control" type="text" data-bv-field="Package_Charge"><i class="form-control-feedback" data-bv-icon-for="Package_Charge" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="Seating" placeholder="Total seating" class="form-control" type="text" data-bv-field="Seating"><i class="form-control-feedback" data-bv-icon-for="Seating" style="display: none;"></i>
    </div>
  </div>
</div>
...
<div class="form-group has-feedback">
  ...
  <input name="confirm_password" placeholder="Remark" class="form-control" type="text" data-bv-field="confirm_password"><i class="form-control-feedback" data-bv-icon-for="confirm_password" style="display: none;"></i>
    </div>
  </div>
</div>
