                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
							...
							<li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class=" mdi mdi-cart-plus"></i><span> PATIENTS </span> <span class="menu-arrow"></span></a>
...
<div  class="table-responsive">
                                    <table id="datatable-responsive" class="table table-striped  table-colored table-info draggable">
										...
										?>
                                        <tr id="tr2">                                            
                                           <td draggable="true" id="<?php echo $row[0]; ?>" ondragstart="drag(event)"><?php echo $row[0]; ?></td>
										   <td draggable="true" id="<?php echo $row[1]; ?>" ondragstart="drag(event)" ><?php echo $row[1]; ?></td>
										   <td draggable="true" id="<?php echo $row[2]; ?>" ondragstart="drag(event)"><?php echo $row[2]; ?></td>
										    <td draggable="true" id="<?php echo $row[3]; ?>" ondragstart="drag(event)"><img src='img_pat/<?php echo $row[3]; ?>' height=50 width=50></td>
										   <td draggable="true" id="<?php echo $row[4]; ?>" ondragstart="drag(event)"><?php echo $row[4]; ?></td>
										   
										   <td draggable="true" id="<?php echo $row[6]; ?>" ondragstart="drag(event)"><?php echo $row[6]; ?></td>
										   <td draggable="true" id="<?php echo $row[9]; ?>" ondragstart="drag(event)"><?php echo $row[9]; ?></td>
										   <td draggable="true"id="<?php echo $row[15]; ?>" ondragstart="drag(event)"><?php echo $row[15]; ?></td>
										   <td > <button type="button" class="btndel btn-danger" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal2"><i class="fa fa-trash-o"></i></button> </td>
										   <td> <button type="button" class="btnupd btn-success" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal3"><i class="fa fa-pencil" ></i></button></td>
	                                    </tr>
											<?php
											} ?>
						            </tbody>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row m-t-20">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="button" id="dialogyes" class="btnyes btn active btn-primary waves-effect waves-light">YES</button>				
		...
		<div id="MyModal3" class="modal" aria-labelledby="myModalLabel" data-animation="bounceIn">  
                <section class="panel panel-info panel-color">
                    <header class="panel-heading">
						...
						<button type="button" class="close" onclick="window.location.href='centre_edit.php'" style="margin-top: -18px;">&times;</button>
                    </header>
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
...
$("td").dblclick(function() {
		...
		<script src="assets\js\patientedit_main.js"></script>
