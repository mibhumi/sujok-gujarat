...
$('#submit').click(function(){
    ...
    var c = document.getElementById("file").value;
     var h = c.replace("fakepath", "");
	 var y = h.replace("C:", "");
	  var x = y.replace("\\", "");
	  var m= document.getElementById("Product_Name").value;
	  var n=m+x;
   ...
   // document.getElementById("demo").innerHTML = x;
				...
				//var hello = file.value.replace("C:\fakepath\", "");
				$.ajax({
					url:"insert_product.php",
					method:"POST",
					data:{Product_Name:$('#Product_Name').val(),Product_Price:$('#Product_Price').val(),Description:$('#Description').val(),Product_Image:n,Remark:$('#Remark').val()},
