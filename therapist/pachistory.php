...
<html>
            ...
            <div class="content-page">
                ...
                <div class="content">
					...
					<?php
						...
						$str="select * from package_account";
						$res=mysqli_query($conn,$str);
					?>
	...
	<a href="seating.php" class="btn btn-success"> <i class=" mdi mdi-cart-plus"></i> 	Buy Packages </a>	<a href="pachistory.php" class="btn btn-success"> <i class=" mdi mdi-cart"></i>Package History</a>							   
                                    </p>
					...
					$str2="select Patient_Name from patient where Patient_Id='$row[1]'";
					...
					$str3="select Package_Name from package where Package_Id='$row[2]'";
