...
$bodyContent = '<h1>You are successfully registered</h1>';
                                            ...
                                            <div class="p-20">
                                                <form id="contact_form" method="post" enctype="multipart/form-data">
													...
													<div class="form-group">
                                                        ...
                                                        <input type="Occupation" required placeholder="Enter Occupation" class="form-control" id="Occupation" name="Occupation">
                                                    </div>
													<div class="form-group">
                                                        <label>Remark<span class="text-danger"></span></label>
                                                        <textarea id="Remark" class="form-control" placeholder="Enter Remark" name="Remark" ></textarea>
                                                    </div><br><br> 													
