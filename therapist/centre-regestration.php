                                            ...
                                            <div class="p-20">
                                                <form >
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" required placeholder="Enter Centre Name" class="form-control" id="CentreName">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Centre Address<span class="text-danger">*</span></label>
                                                        <div>
                                                            <input type="text" class="form-control" required  placeholder="Enter centre Address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="contact"  placeholder="Enter contact number" class="form-control" id="contact" required >
                                                    </div>
													<div class="form-group">
                                                        <label >Centre Code<span class="text-danger">*</span></label>
                                                        <input type="text" name="centrecode"  placeholder="Enter centre code" class="form-control" id="centrecode" required >
                                                    </div>
