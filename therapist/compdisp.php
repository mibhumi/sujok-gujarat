            ...
            <div class="content-page">
                ...
                <div class="content">
					...
					<?php
						...
						$str="select * from complaint where Centre_Id=$cid order by Complaint_Id desc";
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped  table-colored table-info">
                                        <thead>
                                        <tr id="tr1">
											<th width="13%">Complaint Id</th>
                                            <th width="10%">Patient Name</th>
											<th width="13%">Complaint Date</th>
											
											<th width="7%">Centre Id</th>
                                        ...
                                        <tr id="tr2">                                            
                                           <td width="10%" id="td1"><?php echo $row[0]; ?></td>
										    <td width="13%"><?php
										   		...
										   		$str="select * from patient where Patient_Id = $row[1]";
