    ...
    <body class="fixed-left">
		...
		<?php
													...
													if(isset($_REQUEST['upic']))
													{
														...
														$sql="update therapist set Photo='$therapist_pic' where Therapist_Id='4'";
		...
		<?php
													...
													if(isset($_REQUEST['save']))
													{
														...
														$sql="update therapist set Username='$uname',Password='$pass',Address='$add',Contact='$contact' where Therapist_Id='4'";
