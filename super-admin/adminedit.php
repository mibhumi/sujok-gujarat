					...
					<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><a  href="admin-regestration.php" class="btn btn-success"><i class="ion-plus-round "></i>Add Therapist</a></h4>
			...
			//							$cid=$_SESSION['Centre_Id'];
                                    ...
                                    <table id="datatable-responsive" class="table table-striped  table-colored table-info draggable">
                                        ...
                                        <tr id="tr2">                                            
										    ...
										    <td draggable="true" ondragstart="drag(event)" id="<?php echo $row[0]; ?>"><img src="img_thep/<?php echo $row[2]; ?>" width=100px></td>
										 ...
										 <?php  
											...
											<?php }
										   ?>
										   <td> <button type="button" class="btnview  btn-success" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal2"><i class="fa fa-eye"></i></button> 
										    <button type="button" class="btnupd  btn-info" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal3"><i class="fa fa-pencil"></i></button>
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <p id="notdel" > Are you Sure you want to Delete? </p>
                            </div>
                        </div>
...
$("td").dblclick(function() {
	...
	<!--	<script src="assets\js\centreedit_main.js"></script>-->
		...
		<!-- App js -->		<script src="DRAGGABLE.js"></script>
