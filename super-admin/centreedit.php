...
<html>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
					...
					<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><a  href="centre-regestration.php" class="btn btn-success"><i class="ion-plus-round "></i>Add Centre</a></h4>
			...
			//							$cid=$_SESSION['Centre_Id'];
                                    ...
                                    <table id="datatable-responsive" class="table table-striped  table-colored table-info draagable">
                                        <thead>
                                        ...
                                        <tr id="tr2">                                            
										   ...
										   <td draggable="true" ondragstart="drag(event)"> <button type="button" class="btnview  btn-success" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal2"><i class="fa fa-eye"></i></button> 
										    <button type="button" class="btnupd  btn-info" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal3"><i class="fa fa-pencil" ></i>
											</button>
											 <button type="button" class="btndel btn-danger" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal"><i class="fa fa-trash" ></i></button> 
											</td>
						</tr>
								...
								<?php
									...
									<span class="text-danger" id="res1"></span>
                                </div>
                            </div>
                    </div>
				</div>
  ...
  <section class="col-md-4 modal-block">
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <p id="not"> Are you Sure you want to Delete? </p>
                            </div>
                        </div>

                        <div class="row m-t-20">
                            <div class="col-md-12 text-right">
								<button type="button" class="close"  data-dismiss="modal" style="margin-top: -90px;">&times;</button>
                                <button type="button" id="dialogyes" data-toggle="modal" data-target="#MyModal7" class="btnyes btn active btn-primary waves-effect waves-light">YES</button>				
			...
			<section class="col-md-4 modal-block">
                ...
                <section class="panel panel-info panel-color">
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <p id="p2" class="text-primary"> </p>
								<button type="button" class="close"  onclick="window.location.href='centreedit.php'" style="margin-top: -90px;">&times;</button>
                            </div>
                        </div>
			...
			<section class="col-md-5 modal-block">
					</section>
					<div class="modal-block">
                <section class="panel panel-info panel-color ">
                    <header class="panel-heading">
                        ...
                        <div class="modal-wrapper">
                            <div class="modal-text" id="otpbody">
							 ...
							 <div class="col-md-12 text-right">
                                ...
                                <!--<button type="button" id="dialogno" class="btn btn-default waves-effect" data-dismiss="modal">CLOSE</button>-->
                            </div>
                        </div>
					</div>
		...
		<!--update modal-->
			<div id="MyModal3" class="modal" aria-labelledby="myModalLabel" data-animation="bounceIn">  
              <section class="col-md-4 modal-block">
				...
				<section class="panel panel-info panel-color">
                    <header class="panel-heading">
                        <h2 class="panel-title"> Update Therapist </h2>
						<button type="button" class="close" onclick="window.location.href='centreedit.php'" style="margin-top: -18px;">&times;</button>
                    </header>
                    <div class="panel-body">
                        <div class="modal-wrapper">
                        ...
                        <div class="row m-t-20"><span class="text-danger" id="er"></span>
                            <div class="col-md-12 text-right">
                            </div>
                        </div>
                    </div>
...
$("td").dblclick(function() {
		...
		<script src="js\centreedit.js"></script>
