...
<div class="form-group">
  ...
  <input name="city" value="surat" placeholder="Enter City" class="form-control" type="text" >
...
<div class="form-group">
  ...
  <input name="state" value="gujarat" placeholder="Enter State" class="form-control" type="text">
...
<div class="form-group">
  ...
  <input name="pincode" placeholder="Enter Pincode" class="form-control" type="number" >
</div>
...
<div class="form-group">
  ...
  <input name="code" id="code" placeholder="Centre Code" class="form-control" type="text" >
...
<div class="form-group">
  ...
  <a href="centreedit.php" class="btn text-dark " >Cancel</a>
  </div>
</div>
</form>
...
<script src="bootstrapvalidator.min.js"></script>
  ...
  <script src="js\centre-regestration.js"></script>
...
<?php
													if(isset($_POST['add']))
													{
																...
																$code=$_POST['code'];
																$remark=$_POST['remark'];
																$str="insert into centre(Centre_Name,Address,City,State,Pincode,Contact,Centre_Code,Remark) values('$centre_name','$address','$city','$state','$pincode','$contact','$code','$remark')";
