...
<html> <!---->
                    ...
                    <div class="container">
                        ...
                        <div class="row">
							...
							<?php 
								...
								$total = $roww[0];
							?>
                            <a href="patientdisp.php"><div class="col-lg-3 col-md-6">
                            ...
                            <?php 
								...
								$total2 = $roww2[0];
							?>
							<a href="adminedit.php"><div class="col-lg-3 col-md-6">
							...
							<?php 
								...
								$total3 = $roww3[0];
							?>
							<a href="centreedit.php"><div class="col-lg-3 col-md-6">
	...
	<!--	<div id="id1" name="lolo"></div>-->
        ...
        <!-- END wrapper --> <footer class="footer text-right">
