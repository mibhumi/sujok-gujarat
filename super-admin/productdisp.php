...
<html>
    <head>
        ...
        <!-- App title -->
        <title>  All Products </title>     <!-- DataTables -->
  ...
  <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><a  href="new-package.php" class="btn btn-success"><i class="ion-plus-round "></i>Add New Product</a></h4>
	 ...
	 $procedure="SELECT * FROM product";
			...
			$result=mysqli_query($connect,$procedure);
				 ...
				 {?>
						...
						<td draggable="true" ondragstart="drag(event)" id=<?php echo $row[4]; ?>><img src="upload/<?php echo $row[4]; ?>" width=100px></td>
					    <td draggable="true" ondragstart="drag(event)" id=<?php echo $row[5]; ?>><?php echo $row[5]; ?></td>
						<td draggable="true" ondragstart="drag(event)" id=<?php echo $row[5]; ?>><a class="btn btn-success">view</a></td>
