  ...
  <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><a  href="new-product.php" class="btn btn-success"><i class="ion-plus-round "></i>Add New Product</a></h4>
			...
			$result=mysqli_query($connect,$procedure);
				 while($row=mysqli_fetch_array($result))
				 {
					 ?>
						...
						<td draggable="true" ondragstart="drag(event)" id=<?php echo $row[4]?>><img src="upload/<?php echo $row[4]?>" width=100px height=150px/></td>
					    <td draggable="true" ondragstart="drag(event)" id=<?php echo $row[5]?>><?php echo$row[5]?></td>
						   <td> <button type="button" class="btnview  btn-success" id="<?php echo "$row[0]"; ?>" data-toggle="modal" data-target="#MyModal2"><i class="fa fa-eye"></i></button> 
							<button type="button" class="btnupd  btn-info" id="<?php echo "$row[0]"; ?>" onclick="window.location.href='paplupro.php?updateid=<?php echo "$row[0]"; ?>'" ><i class="fa fa-pencil"></i></button> 			
			...
			<section class="col-md-4 modal-block">
                ...
                <section class="panel panel-info panel-color">
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <p id="pres3" class="text-primary"> </p>
								<button type="button" class="close"  onclick="window.location.href='productedit.php'" style="margin-top: -90px;">&times;</button>
                            </div>
                        </div>
                    </div>
