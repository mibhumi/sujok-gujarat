					...
					<div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									Centre :<select name="sel1" id="sp" class=" form-control  " data-style="btn-brown" onchange="showCentre(this.value)">
									...
									<!--<br>
									Patient Id :<input type="text" name="dipid" id="dipid" class=" form-control" data-style="btn-brown" >
					...
					<div id="re">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped  table-colored table-info draggable">
										...
										<td draggable="true" ondragstart="drag(event)" id="<?php echo $row[1]; ?>"><?php echo $row[1]; ?></td>
										   ...
										   <td draggable="true" ondragstart="drag(event)" id="<?php echo $row[3]; ?>"><img src='../therapist/img_pat/<?php echo $row[3]; ?>' height=100px width=100px onclick="openModal(this.src);"></td>
...
$("td").dblclick(function() {
		...
		<script src="js\patientdisp.js"></script>
<script src="js\patientdispid.js"></script>
<script src="DRAGGABLE.js"></script>
