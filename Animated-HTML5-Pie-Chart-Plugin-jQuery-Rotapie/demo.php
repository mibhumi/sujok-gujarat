<?php
$str="select count(Patinet_Id) from Patinet ";
?>
<!doctype html>
<html>
<head>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    <title>jQuery Rotapie Plugin Basic Demo</title>
    <link href="http://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
    <style>
        body{text-align:center; background-color:#333; color:#fff;} 
        h1 { margin:150px auto;}
    </style>
</head>
<body> 
...
<ul>
<li><a href="http://www.jqueryscript.net/chart-graph/Animated-HTML5-Pie-Chart-Plugin-jQuery-Rotapie.html">Download This Plugin</a></li>
...
<div class="jquery-script-clear"></div>
    ...
    <h1>jQuery Rotapie Plugin Basic Demo</h1> 
    <div id="pie"></div> 
